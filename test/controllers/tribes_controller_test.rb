...
class TribesControllerTest < ActionController::TestCase
  ...
  test "should create tribe" do
    assert_difference('Tribe.count') do
      post :create, tribe: { immunity_wins: @tribe.immunity_wins, name: @tribe.name, reward_wins: @tribe.reward_wins, tribe_generation: @tribe.tribe_generation }
    end
  ...
  test "should update tribe" do
    patch :update, id: @tribe, tribe: { immunity_wins: @tribe.immunity_wins, name: @tribe.name, reward_wins: @tribe.reward_wins, tribe_generation: @tribe.tribe_generation }
    assert_redirected_to tribe_path(assigns(:tribe))
  end
