...
class SurvivorsControllerTest < ActionController::TestCase
  ...
  test "should create survivor" do
    assert_difference('Survivor.count') do
      post :create, survivor: { age: @survivor.age, elimination_number: @survivor.elimination_number, fantasy: @survivor.fantasy, name: @survivor.name, photo_url: @survivor.photo_url, residence: @survivor.residence }
    end
  ...
  test "should update survivor" do
    patch :update, id: @survivor, survivor: { age: @survivor.age, elimination_number: @survivor.elimination_number, fantasy: @survivor.fantasy, name: @survivor.name, photo_url: @survivor.photo_url, residence: @survivor.residence }
    assert_redirected_to survivor_path(assigns(:survivor))
  end
